...
public class OAuthWebLogin extends BaseActivity {
    ...
    private WebView createWebView() {
        ...
        web.getSettings().setUserAgentString(com.instructure.pandautils.utils.Utils.generateUserAgent(OAuthWebLogin.this, "candroid"));
    ...
    private void showAuthenticationDialog() {
        ...
        builder.customView(R.layout.dialog_auth, true);
    ...
    public void setupCallback() {
        mobileVerifyCallback = new StatusCallback<DomainVerificationResult>() {
        ...
        getToken = new StatusCallback<OAuthToken>() {
            ...
            public void onResponse(retrofit2.Response<OAuthToken> response, LinkHeaders linkHeaders, ApiType type) {
                ...
                if(type.isAPI()) {
                    ...
                    CanvasRestAdapter.saveLoginInfo(token.getAccessToken(), ApiPrefs.getFullDomain());
    ...
    public static boolean setIsMultipleUsersSupported(boolean multipleUserSupported, Context context, String preferenceKey) {
        ...
        String globalID = getGlobalUserId(ApiPrefs.getDomain(), ApiPrefs.getUser());
    ...
    public static boolean isMultipleUsersSupported(Context context, String preferenceKey) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(preferenceKey, MODE_PRIVATE);
        return sharedPreferences.getBoolean(getGlobalUserId(ApiPrefs.getDomain(), ApiPrefs.getUser()), false);
    }

    public static boolean isUserLoggedIn(Context context) {
        return ApiPrefs.getToken().length() != 0;
    }
