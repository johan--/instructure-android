    ...
    public static void bind(SubmitButtonViewHolder holder, final Context context, CanvasContext canvasContext, final QuizSubmissionQuestionListRecyclerAdapter adapter, final QuizSubmit callback) {
        ...
        holder.submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(hasUnanswered) {
                    String unanswered = context.getResources().getQuantityString(R.plurals.unanswered_quiz_questions, numUnanswered, numUnanswered);
                    dialogStyled = GenericDialogStyled.newInstance(true, R.string.submitQuiz, R.string.areYouSure, R.string.logout_yes, R.string.logout_no, R.drawable.ic_cv_alert_fill, unanswered, listener);
