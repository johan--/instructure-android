...
import com.ebuki.homework.adapter.FileUploadAdapter;
    ...
    private View initViews() {
        ...
        fileList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                newIntent.setDataAndType(FileProvider.getUriForFile(getContext(), getContext().getApplicationContext().getPackageName() + Const.FILE_PROVIDER_AUTHORITY, file), files.get(i).getContentType());
