...
import com.ebuki.homework.BuildConfig;
import com.ebuki.homework.R;
import com.ebuki.homework.adapter.CourseNavigationAdapter;
import com.ebuki.homework.delegate.Navigation;
import com.ebuki.homework.dialog.AccountNotificationDialog;
import com.ebuki.homework.dialog.HelpDialogStyled;
import com.ebuki.homework.fragment.AnnouncementListFragment;
import com.ebuki.homework.fragment.ApplicationSettingsFragment;
import com.ebuki.homework.fragment.BookmarksFragment;
import com.ebuki.homework.fragment.CalendarListViewFragment;
import com.ebuki.homework.fragment.CourseGridFragment;
import com.ebuki.homework.fragment.DetailedConversationFragment;
import com.ebuki.homework.fragment.DetailedDiscussionFragment;
import com.ebuki.homework.fragment.DiscussionListFragment;
import com.ebuki.homework.fragment.GradesGridFragment;
import com.ebuki.homework.fragment.InboxFragment;
import com.ebuki.homework.fragment.LTIWebViewFragment;
...
import com.ebuki.homework.interfaces.OnEventUpdatedCallback;
import com.ebuki.homework.model.PushNotification;
import com.ebuki.homework.receivers.PushExternalReceiver;
import com.ebuki.homework.tasks.LogoutAsyncTask;
import com.ebuki.homework.tasks.SwitchUsersAsyncTask;
import com.ebuki.homework.util.Analytics;
import com.ebuki.homework.util.ApplicationManager;
import com.ebuki.homework.util.FragUtils;
import com.ebuki.homework.util.RouterUtils;
import com.ebuki.homework.util.TabHelper;
import com.ebuki.homework.view.ActionbarCourseSpinner;
import com.ebuki.homework.view.SpinnerInteractionListener;
...
public class NavigationActivity extends BaseRouterActivity implements
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if(intent != null
                && intent.hasExtra(com.ebuki.homework.util.Const.LANGUAGES_PENDING_INTENT_KEY)
                && intent.getIntExtra(com.ebuki.homework.util.Const.LANGUAGES_PENDING_INTENT_KEY, 0) != com.ebuki.homework.util.Const.LANGUAGES_PENDING_INTENT_ID) {
