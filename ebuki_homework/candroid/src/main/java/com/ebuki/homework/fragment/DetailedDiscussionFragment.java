...
import com.ebuki.homework.dialog.FileUploadDialog;
import com.ebuki.homework.model.FormatHtmlObject;
import com.ebuki.homework.util.DiscussionEntryHTMLHelper;
import com.ebuki.homework.util.FragUtils;
import com.ebuki.homework.util.LockInfoHTMLHelper;
import com.ebuki.homework.util.LoggingUtility;
import com.ebuki.homework.util.Param;
import com.ebuki.homework.util.RouterUtils;
import com.ebuki.homework.view.AdvancedViewFlipper;
import com.ebuki.homework.view.CanvasEditTextView;
import com.ebuki.homework.view.CanvasLoading;
...
public class DetailedDiscussionFragment extends ParentFragment implements
    ...
    // logic
    private ArrayList<Long> aboutToMarkRead = new ArrayList<>();
    ...
    /**
     * For explanation of isWithinAnotherCallback and isCached refer to comment in {@link com.ebuki.homework.activity.CallbackActivity#getUserSelf}
     */
