...
public class Submission extends CanvasModel<Submission> {
    ...
    private HashMap<String, RubricCriterionAssessment> rubricAssessment = new HashMap<>();
    ...
    public HashMap<String, RubricCriterionAssessment> getRubricAssessment() {
    ...
    /*allowable values, from the docs: https://github.com/instructure/canvas-lms/blob/stable/app/controllers/submissions_api_controller.rb
        "graded"
        "submitted"
        "unsubmitted"
        "pending_review"
    */
    ...
    public void setRubricAssessment(HashMap<String, RubricCriterionAssessment> rubricAssessment) {
    ...
    protected Submission(Parcel in) {
        ...
        this.rubricAssessment = (HashMap<String, RubricCriterionAssessment>) in.readSerializable();
