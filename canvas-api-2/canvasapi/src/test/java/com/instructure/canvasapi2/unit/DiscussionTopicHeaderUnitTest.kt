...
class DiscussionTopicHeaderUnitTest : Assert() {
    ...
    fun testDiscussionTopicHeader() {
        ...
        Assert.assertTrue(discussionTopicHeader.isPinned)
        ...
        Assert.assertNotNull(discussionTopicHeader.lastReplyAt)

        Assert.assertNotNull(discussionTopicHeader.message)

        Assert.assertNotNull(discussionTopicHeader.message)

        Assert.assertNotNull(discussionTopicHeader.postedAt)
    ...
    private fun testDiscussionAttachments(attachments: List<RemoteFile>) {
        ...
        for (attachment in attachments) {
            ...
            Assert.assertNotNull(attachment.isLocked)
            Assert.assertNotNull(attachment.isLockedForUser)
            Assert.assertNotNull(attachment.isHidden)
            Assert.assertNotNull(attachment.isHiddenForUser)
    ...
    private fun testDiscussionPermissions(permission: DiscussionTopicPermission) {
        ...
        Assert.assertNotNull(permission.isAttach)
        Assert.assertNotNull(permission.isUpdate)
        Assert.assertNotNull(permission.isDelete)
    }
