...
public class LockedModuleTest {

    private LockedModule getValidLockedModule() {
        LockedModule module = new LockedModule();
        module.setContextId(1);
        module.setName("module");
        module.setUnlockAt("2017-01-15T15:53:00+07:00");
        return module;
    }

    @Test
    public void isLockedModuleValid_InvalidContextId() {
