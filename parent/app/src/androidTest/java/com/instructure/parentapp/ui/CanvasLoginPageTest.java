...
public class CanvasLoginPageTest extends ParentTest {
    @Before
    public void setup() {
        parentloginPage.clickLogInWithCanvasButton();
        canvasDomainPickerPage.enterDomain("canvas.instructure.com");
    }
    ...
    @Test
    public void routesToCanvasDomainPickerPage_backButton() {
        canvasLoginPage.clickBackButton();
