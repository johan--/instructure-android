...
import com.instructure.parentapp.fragments.AccountNotificationFragment;
...
public class DetailViewActivity extends BaseRouterActivity {
    ...
    public enum DETAIL_FRAGMENT {WEEK, ASSIGNMENT, EVENT, ANNOUNCEMENT, SYLLABUS, ACCOUNT_NOTIFICATION}
    ...
    public static Intent createIntent(Context context, DETAIL_FRAGMENT fragment, AccountNotification accountNotification, Student student){
        Intent intent = createIntent(context, fragment);
        intent.putExtra(Const.ACCOUNT_NOTIFICATION, (Parcelable)accountNotification);
        intent.putExtra(Const.STUDENT, (Parcelable) student);
        return intent;
    }
