...
public class AssignmentUtils2 {
    ...
    public static int getAssignmentState(@Nullable Assignment assignment, @Nullable Submission submission) {
        //Case - Error
        if(assignment == null){
    ...
    private static int checkOnTimeOrLate(Assignment assignment, Submission submission, boolean hasNoGrade) {
        if(hasNoGrade) {
