...
public class ActivityContentVideoViewClient implements ContentVideoViewClient {
    ...
    private HostingView mDialogFragmentCallback;

    public interface HostingView {
        @Nullable Dialog getDialogFragment();
    }

    public ActivityContentVideoViewClient(Activity activity, HostingView hostingView)  {
        this.mActivity = activity;
        mDialogFragmentCallback = hostingView;
    }
    ...
    private Dialog getDialog() {
        if (mDialogFragmentCallback != null) {
            return mDialogFragmentCallback.getDialogFragment();
        }
        return null;
    }
