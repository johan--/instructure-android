...
class UnsavedChangesContinueDialog : AppCompatDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialog = AlertDialog.Builder(context)
                .setTitle(R.string.continueWithoutSavingTitle)
                .setMessage(R.string.continueWithoutSavingMessage)
                .setPositiveButton(R.string.continueUnsaved, null)
                .setNegativeButton(R.string.cancel) { _, _ -> mListener?.invoke() }
                .create()
        return dialog.apply {
            setOnShowListener {
