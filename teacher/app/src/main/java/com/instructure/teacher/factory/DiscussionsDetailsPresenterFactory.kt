...
class DiscussionsDetailsPresenterFactory(
        ...
        val skipId: String,
        val isAnnouncement: Boolean) : PresenterFactory<DiscussionsDetailsPresenter> {
    override fun create() = DiscussionsDetailsPresenter(
            canvasContext, discussionTopicHeader, discussionTopic, discussionEntryId, skipId, isAnnouncement)
}