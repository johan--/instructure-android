...
class FileFolderPublishedStatusIconView @JvmOverloads constructor(
    ...
    fun setPublishedStatus(fileFolder: FileFolder) {
        ...
        if (!fileFolder.isLocked && !fileFolder.isHidden && fileFolder.lockAt == null && fileFolder.unlockAt == null) {
            // Published
        ...
        } else if (fileFolder.isHidden || fileFolder.lockAt != null || fileFolder.unlockAt != null) {
            // Restricted
