...
class CriterionRatingButton @JvmOverloads constructor(
    ...
    private val mAddDrawable by lazy {
        ContextCompat.getDrawable(context, R.drawable.vd_add).apply {
            setColorFilter(ContextCompat.getColor(context, R.color.defaultTextGray), PorterDuff.Mode.SRC_ATOP)
    ...
    private fun makeBackground() = StateListDrawable().apply {
        val selectedState = ContextCompat.getDrawable(context, R.drawable.bg_criterion_button_selected)
        val pressedState = ContextCompat.getDrawable(context, R.drawable.bg_criterion_button_unselected)
        val defaultState = ContextCompat.getDrawable(context, R.drawable.bg_criterion_button_unselected)
        if (isInEditMode) {
            selectedState.setColorFilter(ContextCompat.getColor(context, R.color.canvas_default_primary), PorterDuff.Mode.SRC_ATOP)
            pressedState.setColorFilter(ContextCompat.getColor(context, R.color.canvas_default_primary), PorterDuff.Mode.SRC_ATOP)
        } else {
