...
class SpeedGraderFilesPresenter(private var mSubmission: Submission?) : SyncPresenter<Attachment, SpeedGraderFilesView>(Attachment::class.java) {
    ...
    override fun loadData(forceNetwork: Boolean) {
        ...
        if (Assignment.getSubmissionTypeFromAPIString(mSubmission?.submissionType) == Assignment.SUBMISSION_TYPE.MEDIA_RECORDING) {
        ...
        if (type != Assignment.SUBMISSION_TYPE.ONLINE_URL) {
